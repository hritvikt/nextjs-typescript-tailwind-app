...
"[project]/.next-internal/server/app/api/download/app/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/download/app/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    return new Promise((resolve, reject)=>{
        try {
            ...
            archive.on('end', ()=>{
                ...
                resolve(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](zipBuffer, {
                    headers: {
            ...
            archive.on('error', (err)=>{
                ...
                reject(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Failed to generate ZIP file', {
                    status: 500
                }));
            });
            ...
            filesToInclude.forEach((fileOrDir)=>{
                const filePath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), fileOrDir);
                if ((0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"])(filePath)) {
                    if (fileOrDir.includes('/')) {
                        // If it's a directory path, add it as a directory
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56541f14._.js.map